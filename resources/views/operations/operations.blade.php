  ...
  <x-slot name="header">
    <div class="flex justify-between">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight p-2" style="border-radius: 5px; border: 2px solid @if ($role == 'admin') green @elseif ($role == 'Personal Page') orange @else red @endif">
        {{strtoupper($role)}}
      </h2>
    </div>
  </x-slot>
