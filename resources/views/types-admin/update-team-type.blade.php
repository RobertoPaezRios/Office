        ...
        <form action="{{route('update.update-team-type', $type->uuid)}}" method="POST">
          ...
          <div class="flex justify-between gap-4">
            ...
            <div class="w-full">
              ...
              <x-input type="number" step="0.01" name="sip" id="sip" value="{{$type->sip}}" class="w-full" placeholder="% S.I.P"/>
          ...
          <div class="flex justify-between gap-4">
            <div class="w-full">
              ...
              <x-input type="number" step="0.01" name="central" id="central" value="{{$type->central}}" class="w-full mt-2" placeholder="% Central"/>
              <x-input-error for="central"></x-input-error>
            </div>
            
            <div class="w-full">
              <x-label for="marketing" class="mt-2 text-left">% Marketing:</x-label>
              <x-input type="number" step="0.01" name="marketing" id="marketing" value="{{$type->marketing}}" class="w-full mt-2" placeholder="% Marketing"/>
          ...
          <div class="flex justify-between gap-4">
            <div class="w-full">
              ...
              <x-input type="number" step="0.01" name="support" id="support" value="{{$type->support}}" class="w-full mt-2" placeholder="% Support"/>
